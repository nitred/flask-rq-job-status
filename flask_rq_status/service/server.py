...
def register_extensions(app, config):
    """Register extensions."""
    from flask_rq_status.service.blueprints.status import status_manager
    status_manager.init_app(app)


def register_blueprints(app, config):
    """Initialize blueprints."""
    from flask_rq_status.service.blueprints.landing import landing_handler
    app.register_blueprint(landing_handler, url_prefix="/landing")

    from flask_rq_status.service.blueprints.status import status_handler
